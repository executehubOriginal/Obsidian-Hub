...
function StartObsidianBlack()
    ...
    local function CreateObsidianUI()
        ...
        sizeInfo.Text = "Используй кнопки + и − вверху окна для изменения размера.\n\nПеретаскивание: тянни за заголовок окна.\nКружок ◉ слева — скрыть/показать GUI с анимацией (тоже перетаскиваемый).\n\nГорячие клавиши:\nRightShift — скрыть/показать\nR — аварийное закрытие"
        ...
        circleBtn.Size = UDim2.new(0, 56, 0, 56)
        circleBtn.Position = UDim2.new(0, 20, 0.5, -28)
        ...
        circleTip.Position = UDim2.new(1, 8, 0.5, -11)
        ...
        local function HideMainWithAnimation()
            ...
            -- Анимация: сворачивание к центру окна + исчезновение
            local hideTween = TweenService:Create(
                ...
                TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.In),
                {
                    ...
                    Position = UDim2.new(
                        savedMainPos.X.Scale, savedMainPos.X.Offset + (savedMainSize.X.Offset / 2),
                        savedMainPos.Y.Scale, savedMainPos.Y.Offset + (savedMainSize.Y.Offset / 2)
                    )
                }
            )
            hideTween:Play()
            ...
            hideTween.Completed:Connect(function()
                if guiHidden then main.Visible = false end
            end)
        end
        ...
        local function ShowMainWithAnimation()
            ...
            -- Стартуем из 0-размера в сохранённый размер
